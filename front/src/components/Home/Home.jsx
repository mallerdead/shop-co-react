        ...
        <div className={styles.home}>
            <div className={`container ${styles.landing}`}>
                <div className={styles.landingWrapper}>
                    ...
                    <div className={styles.text}>Browse through our diverse range of meticulously crafted garments, designed to bring out your individuality and cater to your sense of style.</div>
                    <a href="/shop" className={styles.shopNowButton}>Shop Now</a>
            ...
            <div className={`container ${styles.offers}`}>
                <div className={styles.arrivals}>
                    ...
                    <div className={styles.clothes}>
                        {isLoading ? <LoadingSpinner /> : newArrivals.map(cloth => <ClothItem key={cloth.id} cloth={cloth} />)}
                    </div>
                    <a href='/shop' className={styles.viewAllButton}>View All</a>
                </div>
                <div className={styles.rowDelimiter}></div>
                <div className={styles.topSelling}>
                    <div className={styles.sellingTitle}>Top Selling</div>
                    <div className={styles.clothes}>
                        {isLoading ? <LoadingSpinner /> : topSelling.map(cloth => <ClothItem key={cloth.id} cloth={cloth} />)}
                    </div>
                    <a href="/shop" className={styles.viewAllButton}>View All</a>
                </div>
