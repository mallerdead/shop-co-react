...
import { FooterButton, FooterBadge } from '..'

export const Footer = () => {
    return (
        <div className={`container ${styles.footer}`}>
            <div className={styles.latestOffers}>
                <div className={styles.text}>STAY UPTO DATE ABOUT OUR LATEST OFFERS</div>
                <div className={styles.userMail}>
                    <div className={styles.mailBar}><img src="/src/assets/mail.svg" alt="" /><input type="text" placeholder='Enter your email address' /></div>
            ...
            <div className={styles.usefulLinks}>
                ...
                <div className={styles.linksWrapper}>
                    ...
                    <div className={styles.links}>
                        <div className={styles.titleLinks}>HELP</div>
                        <div className={styles.link}>Customer Support</div>
                        <div className={styles.link}>Delivery Details</div>
                        <div className={styles.link}>Terms & Conditions</div>
                        <div className={styles.link}>Privacy Policy</div>
                    </div>
                    <div className={styles.links}>
                        <div className={styles.titleLinks}>FAQ</div>
                        <div className={styles.link}>Account</div>
                        <div className={styles.link}>Manage Deliveries</div>
                        <div className={styles.link}>Orders</div>
                        <div className={styles.link}>Payments</div>
                    </div>
                    <div className={styles.links}>
                        <div className={styles.titleLinks}>RESOURCES</div>
                        <div className={styles.link}>Free eBooks</div>
                        <div className={styles.link}>Development Tutorial</div>
                        <div className={styles.link}>How to - Blog</div>
                        <div className={styles.link}>Youtube Playlist</div>
                    </div>
                </div>
            </div>
            <div className={styles.footerCopyright}>
                <div className={styles.copyright}>Shop.co © 2000-2023, All rights reserved</div>
                <div className={styles.badges}>
                    <FooterBadge link={"visa"} />
                    <FooterBadge link={"mastercard"} />
                    <FooterBadge link={"paypal"} />
                    <FooterBadge link={"apple pay"} />
                    <FooterBadge link={"g pay"} />
                </div>
            </div>
        </div >)
}